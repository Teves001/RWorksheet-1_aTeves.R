...
orgMatrix #It combines two sequences of numbers: 1 to 8 and 11 to 14, arranging them into the specified[,1] [,2] [,3] [,4]
#[1,] 1 4 7 12
#[2,] 2 5 8 13
#[3,] 3 6 11 14
# [,1] [,2] [,3] [,4]
...
orgMatrix_new # multiplies every element in the orgMatrix by 2 and stores the result in a new matrix ca[,1] [,2] [,3] [,4]
#[1,] 2 8 14 24
#[2,] 4 10 16 26
#[3,] 6 12 22 28
